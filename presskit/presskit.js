  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    if (typeof projectDetails !== "undefined") {
      ...
      if (typeof projectDetails.link !== "undefined") {
        ...
        linkTitle.innerHTML = "🖥 Link to Steam Store Page";
      ...
      if (typeof projectDetails.creators !== "undefined") {
        ...
        for (var i = 0; i < creatorsArray.length; i++) {
          ...
          if (typeof creatorsArray[i].portfolio !== "undefined") {
            creatorsTextArea.append("\n");
            creatorsTextArea.append("Website: " + creatorsArray[i].portfolio);
          }
      ...
      // logos section
      if (typeof projectDetails.logo !== "undefined") {
        var logo = document.createElement("div");
        logo.classList.add("section");
        logo.id = "logo";
        conteiner.append(logo);

        var logoTitle = document.createElement("div");
        logoTitle.classList.add("section_title");
        logoTitle.innerHTML = "🕹️ Logo";
        logo.append(logoTitle);

        for (var l = 0; l < projectDetails.logo.length; l++) {
          var photo = document.createElement("div");
          photo.classList.add("photo");
          photo.id = "photo" + l;
          logo.append(photo);

          if (typeof projectDetails.logo[l].logoImg !== "undefined") {
            var photoBtns = document.createElement("div");
            photoBtns.classList.add("buttons");
            photo.append(photoBtns);

            photoBtns.append(
              getDownloadButton(projectDetails.logo[l].logoImg)
            );
            ...
            photoTextArea.append(projectDetails.logo[l].logoImg);
            photo.append(photoTextArea);

            var photoImg = document.createElement("img");
            photoImg.src = projectDetails.logo[l].logoImg;
